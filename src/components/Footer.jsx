...
const Footer = () => {
  return (
    <footer className="bg-[#0E3995] text-white text-center lg:text-left">
      <div className="mx-6 py-10 text-center md:text-left">
        <div className="grid gap-8 md:grid-cols-2 lg:grid-cols-4">
          ...
          <div>
            ...
            <p>Plot 122, Gbadaga Street, Lagos</p>
            <p>No 30 Victoria Crescent, Abuja</p>
            <div className="flex justify-center md:justify-start mt-4 space-x-4">
              <span>
                <svg viewBox="0 0 860 1000" fill="currentColor" height="2em" width="2em">
          ...
          <div>
            ...
            <p className="mb-4 flex items-center justify-center md:justify-start">
              ...
              <span className="ml-2">+7889 Mechanic Rd. Miami, FL 33125</span>
            </p>
            <p className="flex items-center justify-center md:justify-start">
              <svg viewBox="0 0 24 24" fill="currentColor" height="1em" width="1em">
                <path d="M22 6c0-1.1-.9-2-2-2H4c-1.1 0-2 .9-2 2v12c0 1.1.9 2 2 2h16c1.1 0 2-.9 2-2V6m-2 0l-8 5-8-5h16m0 12H4V8l8 5 8-5v10z" />
              </svg>
              <span className="ml-2">Handyman@domain.com</span>
            </p>
          </div>
        </div>
      </div>
